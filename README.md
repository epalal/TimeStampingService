...
i) the (pubKc,privKc) pair which is used to establish a secure connection with the service; 
ii) the (pubKts, privKts) pair which is used to digitally sign the timestamp.
